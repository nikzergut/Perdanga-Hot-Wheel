...
function Wheel() {
    ...
    useEffect(() => {               
        ...
        drawWheel(ctx, gameCounter, radius, centerX, centerY, gameList)
    ...
    return(
        <div className={styles.wheelContainer}>
            ...
            <Button onClick={() => {               
                setSpinTime(0)
                spinWheel(6000, ctxRef.current, canvasRef.current, gameList, centerY, centerX, radius, gameCounter, setSpinTime)
            }}>Крутить</Button>
        </div>
    )
}
